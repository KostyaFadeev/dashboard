      ...
      <footer className="border-neutral-300 bg-neutral-50">
        <div className="mx-auto flex flex-wrap max-w-7xl px-4 lg:px-8">
          ...
          <div className="md:ml-4 flex justify-center flex-col">
            <div className="text-2xl mb-2 uppercase font-medium">ЛОВИТЕ НОВОСТИ!</div>
            <div className="text-sm mb-4">
              Будьте в курсе всех изменений, акций и скидок на сервисе
            </div>
            <div className="flex gap-4">
        ...
        <div className="flex flex-col justify-center border-t border-neutral-200 mt-4 py-10 px-4 sm:flex-row">
